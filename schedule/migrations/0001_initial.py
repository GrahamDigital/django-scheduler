# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-11-23 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='updated on')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedule.Event', verbose_name='event')),
                ('livestreamUrl', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.LivestreamUrl')),
            ],
            options={
