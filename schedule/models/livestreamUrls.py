...
class LivestreamUrl(models.Model):
    page_url = models.URLField(max_length=1000, null=True, help_text=_("The url of the livestream page"))
    stream_url = models.URLField(max_length=1000, null=True, help_text=_("The the stream url to be embedded"))
